  ...
  @endif 
    ...
    <div class="page-header">
        ...
        <div class="pull-right">
            <a href="{{route('legal-create')}}" class="btn btn-primary">Add Legal <i class="fa fa-plus"></i></a>
        </div>
                        ...
                        @foreach($legals as $team)
                            ...
                            <td>
                                ...
                                <ul class="dropdown-menu dropdown-menu-right" role="menu"> 
                                    ...
                                    <li><a href="{{route('legal.edit',['id'=>$team->id])}}" target="_blank"><i class="md md-edit"></i> {{trans('words.edit')}}</a></li>
