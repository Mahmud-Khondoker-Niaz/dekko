...
class ItController extends MainAdminController
{
     /**
  ...
  parent::__construct();
    ...
    {
        return view('admin.it.index')->with('its',It::orderBy('created_at','asc')->get());
    }
    ...
    if(Auth::User()->usertype!="Admin"){
       ...
       $image = $request->image_page;
        ...
        Session::flash('Success','It added Successfully.');
        $team->save();
    ...
    if(Auth::User()->usertype!="Admin"){
        ...
        $team= It::find($id);
        return view('admin.it.edit')->with('team',$team);
    }
